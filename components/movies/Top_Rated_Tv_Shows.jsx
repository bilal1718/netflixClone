...
const Top_Rated_Tv = ({AddtoList}) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://api.themoviedb.org/3/tv/top_rated?api_key=58eec0999b7db5c6b801fecec14d2b51`);
    ...
    return (
        <>
        <h1 className='bg-zinc-900 text-white font-extrabold text-4xl p-4'>Top Rated TV Shows</h1>
